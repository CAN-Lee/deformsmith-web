'use strict';
(async () => {
 const grid=document.querySelector('#comparison-grid'), tabs=document.querySelector('#case-tabs'), view=document.querySelector('#view-select'), play=document.querySelector('#play-all'), status=document.querySelector('#video-status');
